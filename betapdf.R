# Bounded by 0 and 1 , generalization of Uniform on 0,1. Can be symmetrical right or left skewed 
# dependng upon alpha and beta
# Ex. Let p be the proportion of defectives in the plant producing a given product, where a
#company has many plants. A model for p could be the Beta
